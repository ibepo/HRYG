...
public class SearchGridListAdapter extends RecyclerView.Adapter {

    List<SearchData.Goods> list;
    Context context;
    ...
    public void setImages(List<SearchData.Goods> list, Context context) {
