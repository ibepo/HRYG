...
public class KFRreash extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//            System.out.println("有多少个头View:"+mHeaders.size()+"值等于多少:"+(mHeaders.size()-1));
    ...
    public final int getItemViewType(int position) {
        ...
        if (isHeader(position)) {
            return TYPE_HEADER;
            //判断集合个数&&position==0  这个时候mHeaders里面是没有值的
    ...
    private class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (onItemClickListener != null) {
                onItemClickListener.onItemClick(KFRreash.this, vh, position);
            }
    ...
    private class MyOnLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            int position = getRealPosition(vh.getLayoutPosition());
            if (KFRreash.this.onItemLongClickListener != null) {
                KFRreash.this.onItemLongClickListener.onItemLongClick(KFRreash.this, vh, position);
            }
    ...
    public static interface OnItemClickListener {
        void onItemClick(KFRreash adapter, RecyclerView.ViewHolder vh, int position);
    }

    public static interface OnItemLongClickListener {
        void onItemLongClick(KFRreash adapter, RecyclerView.ViewHolder vh, int position);
    }

    private RecyclerView.Adapter<RecyclerView.ViewHolder> mAdapter;

    public KFRreash(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        super();
