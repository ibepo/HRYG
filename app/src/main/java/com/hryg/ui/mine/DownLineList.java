...
public class DownLineList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridRv.setLayoutManager(new LinearLayoutManager(DownLineList.this));
    ...
    Observer<IdListBean> observer = new Observer<IdListBean>() {
        ...
        public void onNext(IdListBean data) {
            adapter.setImages(data.getData(), DownLineList.this);
