...
public class ToChangeOrderList extends BaseActivity implements OnLoadMoreListener, OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iRecyclerView.setLayoutManager(new LinearLayoutManager(ToChangeOrderList.this));
    ...
    public void getData(int page) {
        Network.getOrderApi().getChangetOrder(PathConfig.user_id, "1", page + "")
        ...
        public void onNext(BuyOrderListData data) {
            ...
            if (page == 1) {
                if (data.getData() != null) {
                    ...
                    adapter.setImages(data.getData(), ToChangeOrderList.this);
                    page++;
                } else {
