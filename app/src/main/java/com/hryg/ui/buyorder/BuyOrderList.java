...
public class BuyOrderList extends BaseActivity implements OnLoadMoreListener, OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iRecyclerView.setLayoutManager(new LinearLayoutManager(BuyOrderList.this));
    ...
    public void getData(int page) {
        Network.getOrderApi().getAllOrder(PathConfig.user_id, null, page + "")
    ...
    Observer<BuyOrderListData> observer = new Observer<BuyOrderListData>() {
        ...
        public void onNext(BuyOrderListData data) {
            iRecyclerView.setRefreshing(false);
            if (page == 1) {
                adapter.setImages(data.getData(), BuyOrderList.this);
                page++;
            } else {
