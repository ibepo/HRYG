...
public class ToReceiptOrderList extends BaseActivity implements OnLoadMoreListener, OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iRecyclerView.setLayoutManager(new LinearLayoutManager(ToReceiptOrderList.this));
    ...
    public void getData(int page) {
        Network.getOrderApi().getAllOrder(PathConfig.user_id, "30", page + "")
        ...
        public void onNext(BuyOrderListData data) {
            ...
            if (page == 1) {
                if (data.getData() != null) {
                    ...
                    adapter.setImages(data.getData(), ToReceiptOrderList.this);
                    page++;
                } else {
