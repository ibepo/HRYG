...
public class ToReceiptOrderList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridRv.setLayoutManager(new LinearLayoutManager(ToReceiptOrderList.this));
        getData();
    ...
    public void getData() {
        showDialog();
        Network.getOrderApi().getAllOrder(PathConfig.user_id, "20", "1")
