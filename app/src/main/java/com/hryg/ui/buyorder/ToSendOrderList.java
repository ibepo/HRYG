...
public class ToSendOrderList extends BaseActivity implements OnLoadMoreListener, OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iRecyclerView.setLayoutManager(new LinearLayoutManager(ToSendOrderList.this));
    ...
    public void getData(int page) {
        Network.getOrderApi().getAllOrder(PathConfig.user_id, "20", page + "")
